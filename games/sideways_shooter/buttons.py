...
class Buttons:  # pylint: disable=R0902, R0913
    ...
    def __init__(self, s_shooter: "SidewaysShooter", msg: str) -> None:
    ...
    def make_play_button(self) -> None:
        ...
        self._set_button_properties(width=200, height=50, button_color=(200, 124, 83))
    ...
    def make_pause_button(self) -> None:
        ...
        self._set_button_properties(font_size=20, button_color=(106, 90, 205))
    ...
    def make_easy_difficulty_button(self, highlighted: bool = False) -> None:
        ...
        color: tuple[int, int, int] = (55, 45, 65) if highlighted else (180, 104, 63)
    ...
    def make_medium_difficulty_button(self, highlighted: bool = False) -> None:
        ...
        # Highlight it only if the user clicks the button.
        color: tuple[int, int, int] = (55, 45, 65) if highlighted else (160, 84, 43)
        self._set_button_properties(width=200, height=50, button_color=color)
    ...
    def make_hard_difficulty_button(self, highlighted: bool = False) -> None:
        ...
        # Highlight it only if the user clicks the button.
        color: tuple[int, int, int] = (55, 45, 65) if highlighted else (140, 64, 23)
        self._set_button_properties(width=200, height=50, button_color=color)
    ...
    def make_credits_display_button(self, s_shooter: "SidewaysShooter", show_credits: bool = True) -> None:
        """Make a button and use it as a screen where to display the credits."""
        self._set_button_properties(
            width=s_shooter.settings.screen_width,
            height=s_shooter.settings.screen_height,
            font_size=0,
    ...
    def _render_credits_or_hotkeys(self, lines: list[str], show_credits: bool) -> None:
        ...
        if show_credits:
            font: pygame.font.Font = pygame.font.SysFont("Open Sans", 14, bold=True)

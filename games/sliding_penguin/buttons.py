...
class Buttons:  # pylint: disable=R0902, R0913
    ...
    def make_play_button(self) -> None:
        ...
        self._set_button_properties(width=200, height=50, button_color=(255, 165, 0))
    ...
    def make_pause_button(self) -> None:
        ...
        self._set_button_properties(font_size=20, button_color=(0, 102, 204))
    ...
    def make_menu_button(self) -> None:
        ...
        self._set_button_properties(font_size=20, button_color=(0, 128, 0))
    ...
    def make_difficulty_button(self) -> None:
        ...
        self._set_button_properties(font_size=14, button_color=(34, 139, 34))
    ...
    def make_easy_difficulty_button(self, highlighted: bool = False) -> None:
        ...
        color: tuple[int, int, int] = (100, 100, 150) if highlighted else (235, 135, 0)
    ...
    def make_medium_difficulty_button(self, highlighted: bool = False) -> None:
        ...
        # Highlight it only if the user clicks the button.
        color: tuple[int, int, int] = (100, 100, 150) if highlighted else (215, 105, 0)
        self._set_button_properties(width=200, height=50, button_color=color)
    ...
    def make_hard_difficulty_button(self, highlighted: bool = False) -> None:
        ...
        # Highlight it only if the user clicks the button.
        color: tuple[int, int, int] = (100, 100, 150) if highlighted else (195, 75, 0)
        self._set_button_properties(width=200, height=50, button_color=color)
    ...
    def make_scoreboard_button(self, s_penguin: "SlidingPenguin") -> None:
        """Make a button to use as background for the Scoreboard."""
        self._set_button_properties(
            width=s_penguin.settings.screen_width,
            height=(self.sb.scores_images.score_rect.height + 30),
    ...
    def make_hotkeys_button(self) -> None:
        ...
        self._set_button_properties(font_size=15, button_color=(17, 112, 17))
    ...
    def make_credits_button(self) -> None:
        ...
        self._set_button_properties(font_size=15, button_color=(0, 85, 0))
    ...
    def make_credits_display_button(self, s_penguin: "SlidingPenguin", show_credits: bool = True) -> None:
        """Make a button and use it as a screen where to display the credits."""
        self._set_button_properties(
            width=s_penguin.settings.screen_width,
            height=s_penguin.settings.screen_height,
            font_size=0,
    ...
    def _render_credits_or_hotkeys(self, lines: list[str], show_credits: bool) -> None:
        ...
        if show_credits:
            font: pygame.font.Font = pygame.font.SysFont("Tahoma", 8, bold=True)

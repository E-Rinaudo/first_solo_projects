...
class Buttons:  # pylint: disable=R0902, R0913
    ...
    def __init__(self, h_fox: "HungryFox", msg: str) -> None:
    ...
    def make_play_button(self) -> None:
        ...
        self._set_button_properties(width=200, height=50, button_color=(255, 69, 0))
    ...
    def make_pause_button(self) -> None:
        ...
        self._set_button_properties(font_size=20, button_color=(22, 57, 129))
    ...
    def make_easy_difficulty_button(self, highlighted: bool = False) -> None:
        ...
        color: tuple[int, int, int] = (75, 0, 130) if highlighted else (255, 100, 50)
    ...
    def make_medium_difficulty_button(self, highlighted: bool = False) -> None:
        ...
        # Highlight it only if the user clicks the button.
        color: tuple[int, int, int] = (75, 0, 130) if highlighted else (255, 80, 20)
        self._set_button_properties(width=200, height=50, button_color=color)
    ...
    def make_hard_difficulty_button(self, highlighted: bool = False) -> None:
        ...
        # Highlight it only if the user clicks the button.
        color: tuple[int, int, int] = (75, 0, 130) if highlighted else (235, 70, 35)
        self._set_button_properties(width=200, height=50, button_color=color)
    ...
    def make_credits_display_button(self, h_fox: "HungryFox", show_credits: bool = True) -> None:
        ...
        self._set_button_properties(
            ...
            height=h_fox.settings.screen_height,
            font_size=0,

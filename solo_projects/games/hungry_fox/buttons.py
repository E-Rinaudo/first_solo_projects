...
class Buttons:
    ...
    def make_play_button(self):
        ...
        self._set_button_properties((255, 69, 0), width=200, height=50)
    ...
    def make_pause_button(self):
        ...
        self._set_button_properties((22, 57, 129), font_size=20)
    ...
    def make_easy_difficulty_button(self, highlighted=False):
        ...
        if highlighted:
            self._set_button_properties((75, 0, 130), width=200, height=50)
        else:
            self._set_button_properties((255, 100, 50), width=200, height=50)
    ...
    def make_medium_difficulty_button(self, highlighted=False):
        ...
        if highlighted:
            ...
            self._set_button_properties((255, 80, 20), width=200, height=50)
    ...
    def make_hard_difficulty_button(self, highlighted=False):
        ...
        if highlighted:
            ...
            self._set_button_properties((235, 70, 35), width=200, height=50)
    ...
    def _colorize_credits_lines(self, lines):
        ...
        colored_lines = [
            ...
            else self.SOUND_COLOR if ' sound' in line.lower()

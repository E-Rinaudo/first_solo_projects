...
class Buttons:
    ...
    def __init__(self, s_shooter, msg):
    ...
    def make_play_button(self):
        ...
        self._set_button_properties((200, 124, 83), width=200, height=50)
    ...
    def make_pause_button(self):
        ...
        self._set_button_properties((106, 90, 205), font_size=20)
    ...
    def make_easy_difficulty_button(self, highlighted=False):
        ...
        if highlighted:
            self._set_button_properties((55, 45, 65), width=200, height=50)
        else:
            self._set_button_properties((180, 104, 63), width=200, height=50)
    ...
    def make_medium_difficulty_button(self, highlighted=False):
        ...
        if highlighted:
            ...
            self._set_button_properties((160, 84, 43), width=200, height=50)
    ...
    def make_hard_difficulty_button(self, highlighted=False):
        ...
        if highlighted:
            ...
            self._set_button_properties((140, 64, 23), width=200, height=50)
    ...
    def _render_credits_or_hotkeys(self, lines, show_credits):
        ...
        if show_credits:
            font = pygame.font.SysFont("Open Sans", 14, bold=True)

...
def dataset_fixture(weather_plotter: WDP, path: Path) -> WD:
    ...
    weather_plotter.weather_dataset(path, high=True, color="red", alpha=0.7, temp_scale="F°")
...
def test_read_file_not_found(weather_plotter: WDP, dataset: dict[str, Any]) -> None:  # pylint: disable=W0613
...
def test_is_file_read(weather_plotter: WDP, path: Path, dataset: dict[str, Any], header_row: list[str]) -> None:
...
def test_collect_values(dataset: dict[str, Any], first_row: list[str]) -> None:
    ...
    assert dataset["weather_info"]["lows"] == dataset["weather_info"]["precipitations"] == []


def test_does_it_plot(weather_plotter: WDP, dataset: dict[str, Any]) -> None:  # pylint: disable=W0613
...
def test_shade_between(weather_plotter: WDP, dataset: dict[str, Any]) -> None:  # pylint: disable=W0613
...
def test_is_title_customized(weather_plotter: WDP, dataset: dict[str, Any]) -> None:  # pylint: disable=W0613
...
def test_legend(weather_plotter: WDP, dataset: dict[str, Any]) -> None:  # pylint: disable=W0613
